        ...
        >
          {subtitle && (
            <motion.p
              ...
              className="text-sm font-medium tracking-widest uppercase text-neutral-500 dark:text-neutral-400 mb-6"
            >
              {subtitle}
            </motion.p>
          )}
          ...
          <motion.p
            ...
            className="text-base md:text-lg text-neutral-500 dark:text-neutral-400 max-w-xl mx-auto mb-10"
          >
            Consultant Clinical Geneticist · Neurodevelopmental disorders · Rare diseases · Prenatal genetics
          </motion.p>
